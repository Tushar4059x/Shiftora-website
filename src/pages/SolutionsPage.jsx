                ...
                <div className="container">
                    <div className="section-header">
                        ...
                        <h1 className="section-title">
                            Our <span className="gradient-text">Automation Capabilities</span>
                        </h1>
                        <p className="section-subtitle">
                            Enterprise-grade automation solutions designed to scale with your business.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="solutions-grid">
                        {services.map((service, index) => (
                            <Link key={index} to={`/services/${service.slug}`} className="solution-card card">
